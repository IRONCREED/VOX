...
test('ICW-HIST-0048: release 1.13.2 publishes anonymous review copy and progressive About sliders', async () => {
	...
	assert.equal(packageManifest.version, '1.13.2');
	assert.equal(corpus.contentVersion, '1.14.1');
	...
	assert.equal(
		testimonials.link.href.en,
		'https://freelancehunt.com/en/freelancer/r_dubinetskyi.html#reviews',
	);
...
test('ICW-HIST-0048: final interface fixes preserve tokens while repairing clipping and wide layouts', async () => {
