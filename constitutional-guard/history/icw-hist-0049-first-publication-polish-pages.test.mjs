...
test('ICW-HIST-0049: both About locales expose the inline identity and complete no-JS card fallback', async () => {
	...
	assert.match(
		en,
		/href="https:\/\/freelancehunt\.com\/en\/freelancer\/r_dubinetskyi\.html#reviews"/,
	);
...
test('ICW-HIST-0049: article and diagram projections remain complete after layout repair', async () => {
	const site = await createCompiledSiteDriver();
