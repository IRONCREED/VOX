...
test('ICW-HIST-0050: release 1.14.0 publishes anonymous review copy and progressive About sliders', async () => {
	...
	assert.equal(packageManifest.version, '1.14.0');
	assert.equal(corpus.contentVersion, '1.15.0');
...
test('ICW-HIST-0050: final interface fixes preserve tokens while repairing clipping and wide layouts', async () => {
