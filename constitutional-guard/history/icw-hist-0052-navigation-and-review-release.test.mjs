...
test('ICW-HIST-0052: release 1.14.1 publishes anonymous review copy and progressive About sliders', async () => {
	...
	assert.equal(packageManifest.version, '1.14.1');
	assert.equal(corpus.contentVersion, '1.15.1');
...
test('ICW-HIST-0052: final interface fixes preserve tokens while repairing clipping and wide layouts', async () => {
