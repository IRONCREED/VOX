...
test('ICW-HIST-0055: release 1.16.0 publishes anonymous review copy and progressive About sliders', async () => {
	...
	assert.equal(corpus.contentVersion, '1.16.0');
...
test('ICW-HIST-0055: final interface fixes preserve tokens while repairing clipping and wide layouts', async () => {
